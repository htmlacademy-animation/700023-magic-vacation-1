...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    const prevScreen = Array.from(this.screenElements).find((screen) => screen.classList.contains(`active`));
    const timeoutHideScreen = prevScreen && prevScreen.classList.contains(`screen--end-fill`) ? 600 : 0;

    if (prevScreen && timeoutHideScreen) {
      prevScreen.classList.add(`screen--filling`);
    }
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        if (prevScreen) {
          prevScreen.classList.remove(`screen--filling`);
        }
      }, 100);
    }, timeoutHideScreen);
  }
...
/* harmony import */ var _modules_accent_typography_builder__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/accent-typography-builder */ "./source/js/modules/accent-typography-builder.js");
// modules
...
class App {
  ...
  onPageLoad() {
    ...
    const animationTopScreenIntroTitle = new _modules_accent_typography_builder__WEBPACK_IMPORTED_MODULE_9__["default"](`.intro__title`, 500, `text-animate`, `transform`, 500);
    animationTopScreenIntroTitle.runAnimation();

    const animationTopScreenIntroLable = new _modules_accent_typography_builder__WEBPACK_IMPORTED_MODULE_9__["default"](`.intro__label`, 500, `text-animate`, `transform`, 1600);
    animationTopScreenIntroLable.runAnimation();

    const animationTopScreenIntroDate = new _modules_accent_typography_builder__WEBPACK_IMPORTED_MODULE_9__["default"](`.intro__date`, 500, `text-animate`, `transform`, 1600);
    animationTopScreenIntroDate.runAnimation();

    const animationTopScreenSliderItemTitle = new _modules_accent_typography_builder__WEBPACK_IMPORTED_MODULE_9__["default"](`.slider__item-title`, 500, `text-animate`, `transform`, 100);
    animationTopScreenSliderItemTitle.runAnimation();

    const animationTopScreenSliderPrizesTitle = new _modules_accent_typography_builder__WEBPACK_IMPORTED_MODULE_9__["default"](`.prizes__title`, 500, `text-animate`, `transform`, 100);
    animationTopScreenSliderPrizesTitle.runAnimation();

    const animationTopScreenSliderRulesTitle = new _modules_accent_typography_builder__WEBPACK_IMPORTED_MODULE_9__["default"](`.rules__title`, 500, `text-animate`, `transform`, 100);
    animationTopScreenSliderRulesTitle.runAnimation();

    const animationTopScreenSliderGameTitle = new _modules_accent_typography_builder__WEBPACK_IMPORTED_MODULE_9__["default"](`.game__title`, 500, `text-animate`, `transform`, 100);
